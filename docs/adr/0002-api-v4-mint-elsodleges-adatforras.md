...
- Az onboarding utáni SQLite-letöltés véglegesen kikerül a folyamatból — offline-first indítás csak a kezdeti feltöltésre támaszkodik. Ha az API hosszabb ideig elérhetetlen, az app adatai befagynak azon a ponton, ahol utoljára sikerült szinkronizálni (nincs többé napi automatikus teljes újratöltés, mint korábban). Az offline működés részleteit az ADR-0003 rögzíti.
